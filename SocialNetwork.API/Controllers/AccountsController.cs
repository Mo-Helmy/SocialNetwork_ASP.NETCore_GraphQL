using SocialNetwork.Application.Dtos.Authentication;
using SocialNetwork.Application.Dtos.Authentication.ConfirmEmail;
using SocialNetwork.Application.Dtos.Authentication.ConfirmPhone;
using SocialNetwork.Application.Dtos.Authentication.ForgetPassword;
